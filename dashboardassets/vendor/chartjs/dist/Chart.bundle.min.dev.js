    ...
    6: [function (t, e, i) {
      ...
      n = this, a = function a() {
        ...
        function gt(t, e) {
          ...
          for ("string" == typeof t && (t = [t]), l(e) && (n = function n(t, i) {
            i[e] = w(t);
          }), i = 0; i < t.length; i++) {
            ft[t[i]] = n;
          }
      ...
      }, "object" == _typeof(i) && void 0 !== e ? e.exports = a() : n.moment = a();
    }, {}],
    7: [function (t, e, i) {
      var n = t(29)();
      ...
      n._set("line", {
        ...
        t.controllers.line = t.DatasetController.extend({
          ...
          updateElement: function updateElement(t, e, i) {
            ...
            void 0 !== u.radius && void 0 === u.pointRadius && (u.pointRadius = u.radius), void 0 !== u.hitRadius && void 0 === u.pointHitRadius && (u.pointHitRadius = u.hitRadius), n = f.getPixelForValue("object" == _typeof(h) ? h : NaN, e, d), a = i ? c.getBasePixel() : o.calculatePointY(h, e, d), t._xScale = f, t._yScale = c, t._datasetIndex = d, t._index = e, t._model = {
              x: n,
              y: a,
      ...
      n._set("scale", {
        ...
        t.Scale = a.extend({
          ...
          _autoSkip: function _autoSkip(t) {
            ...
            for (l.maxTicksLimit && (a = l.maxTicksLimit), s && (e = !1, (c + l.autoSkipPadding) * u > o.width - (o.paddingLeft + o.paddingRight) && (e = 1 + Math.floor((c + l.autoSkipPadding) * u / (o.width - (o.paddingLeft + o.paddingRight)))), a && u > a && (e = Math.max(e, Math.floor(u / a)))), i = 0; i < u; i++) {
            ...
            if (a.display) {
              ...
              if (r.each(p, function (i, n) {
                ...
                if (c.display && (s.save(), s.lineWidth = t.glWidth, s.strokeStyle = t.glColor, s.setLineDash && (s.setLineDash(t.glBorderDash), s.lineDashOffset = t.glBorderDashOffset), s.beginPath(), c.drawTicks && (s.moveTo(t.tx1, t.ty1), s.lineTo(t.tx2, t.ty2)), c.drawOnChartArea && (s.moveTo(t.x1, t.y1), s.lineTo(t.x2, t.y2)), s.stroke(), s.restore()), d.display) {
                  ...
                  var i = t.label;
                  if (r.isArray(i)) for (var n = i.length, a = 1.5 * y.size, o = e.isHorizontal() ? 0 : -a * (n - 1) / 2, l = 0; l < n; ++l) {
      ...
      var l = a.extend({
        ...
        draw: function draw() {
          ...
          if (i.display) {
            ...
            var x = i.text;
            if (r.isArray(x)) for (var _ = 0, k = 0; k < x.length; ++k) {
