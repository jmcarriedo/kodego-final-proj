...
!function (t, e) {
  ...
  function (_R3) {
    ...
    function Q(e, i) {
      ...
      _this3 = _possibleConstructorReturn(this, _getPrototypeOf(Q).call(this, e)), _this3._items = null, _this3._interval = null, _this3._activeElement = null, _this3._isPaused = !1, _this3._isSliding = !1, _this3.touchTimeout = null, _this3.touchStartX = 0, _this3.touchDeltaX = 0, _this3._config = _this3._getConfig(i), _this3._indicatorsElement = t.findOne(".carousel-indicators", _this3._element), _this3._touchSupported = "ontouchstart" in document.documentElement || navigator.maxTouchPoints > 0, _this3._pointerEvent = Boolean(window.PointerEvent), _this3._addEventListeners();
      return _this3;
    }
    ...
    _createClass(Q, [{
      ...
      value: function _getConfig(t) {
        return t = _objectSpread({}, $, {}, t), d("carousel", t, F), t;
      }
    }, {
      key: "_handleSwipe",
      ...
      value: function carouselInterface(t, e) {
        var i = w.get(t, "bs.carousel"),
            n = _objectSpread({}, $, {}, U.getDataAttributes(t));
  ...
  function (_R4) {
    ...
    function J(e, i) {
      ...
      _this8 = _possibleConstructorReturn(this, _getPrototypeOf(J).call(this, e)), _this8._isTransitioning = !1, _this8._config = _this8._getConfig(i), _this8._triggerArray = t.find("[data-bs-toggle=\"collapse\"][href=\"#".concat(_this8._element.id, "\"],[data-bs-toggle=\"collapse\"][data-bs-target=\"#").concat(_this8._element.id, "\"]"));
    ...
    _createClass(J, [{
      ...
      key: "_getConfig",
      value: function _getConfig(t) {
        return (t = _objectSpread({}, G, {}, t)).toggle = Boolean(t.toggle), d("collapse", t, Z), t;
      }
    }, {
      key: "_getDimension",
      ...
      value: function collapseInterface(t, e) {
        ...
        var n = _objectSpread({}, G, {}, U.getDataAttributes(t), {}, "object" == _typeof(e) && e ? e : {});
  ...
  function (_R5) {
    ...
    function we(t, e) {
      ...
      _this12 = _possibleConstructorReturn(this, _getPrototypeOf(we).call(this, t)), _this12._popper = null, _this12._config = _this12._getConfig(e), _this12._menu = _this12._getMenuElement(), _this12._inNavbar = _this12._detectNavbar(), _this12._addEventListeners();
      return _this12;
    }
  ...
  function () {
    ...
    _createClass(De, [{
      ...
      key: "_getConfig",
      value: function _getConfig(t) {
        return (t = _objectSpread({}, Ce, {}, "object" == _typeof(t) ? t : {})).rootElement = t.rootElement || document.body, d("backdrop", t, xe), t;
      }
    }, {
      key: "_append",
  ...
  function (_R6) {
    ...
    function Ie(e, i) {
      ...
      _this18 = _possibleConstructorReturn(this, _getPrototypeOf(Ie).call(this, e)), _this18._config = _this18._getConfig(i), _this18._dialog = t.findOne(".modal-dialog", _this18._element), _this18._backdrop = _this18._initializeBackDrop(), _this18._isShown = !1, _this18._ignoreBackdropClick = !1, _this18._isTransitioning = !1;
      return _this18;
    }
    ...
    _createClass(Ie, [{
      ...
      key: "_getConfig",
      value: function _getConfig(t) {
        return t = _objectSpread({}, Ne, {}, U.getDataAttributes(this._element), {}, t), d("modal", t, Se), t;
      }
    }, {
      key: "_showElement",
  ...
  function (_R7) {
    ...
    function Me(t, e) {
      ...
      _this29 = _possibleConstructorReturn(this, _getPrototypeOf(Me).call(this, t)), _this29._config = _this29._getConfig(e), _this29._isShown = !1, _this29._backdrop = _this29._initializeBackDrop(), _this29._addEventListeners();
      return _this29;
    }
    ...
    _createClass(Me, [{
      ...
      key: "_getConfig",
      value: function _getConfig(t) {
        return t = _objectSpread({}, je, {}, U.getDataAttributes(this._element), {}, "object" == _typeof(t) ? t : {}), d("offcanvas", t, Pe), t;
      }
    }, {
      key: "_initializeBackDrop",
      value: function _initializeBackDrop() {
  ...
  function (_R8) {
    ...
    function Xe(t, e) {
      ...
      _this35 = _possibleConstructorReturn(this, _getPrototypeOf(Xe).call(this, t)), _this35._isEnabled = !0, _this35._timeout = 0, _this35._hoverState = "", _this35._activeTrigger = {}, _this35._popper = null, _this35._config = _this35._getConfig(e), _this35.tip = null, _this35._setListeners();
      return _this35;
    }
  ...
  var Ye = new RegExp("(^|\\s)bs-popover\\S+", "g"),
    ...
    template: '<div class="popover" role="tooltip"><div class="popover-arrow"></div><h3 class="popover-header"></h3><div class="popover-body"></div></div>'
      ...
      Ge = _objectSpread({}, Xe.DefaultType, {
  ...
  function (_R9) {
    ...
    function ii(t, e) {
      ...
      _this41 = _possibleConstructorReturn(this, _getPrototypeOf(ii).call(this, t)), _this41._scrollElement = "BODY" === _this41._element.tagName ? window : _this41._element, _this41._config = _this41._getConfig(e), _this41._selector = "".concat(_this41._config.target, " .nav-link, ").concat(_this41._config.target, " .list-group-item, ").concat(_this41._config.target, " .dropdown-item"), _this41._offsets = [], _this41._targets = [], _this41._activeTarget = null, _this41._scrollHeight = 0, H.on(_this41._scrollElement, "scroll.bs.scrollspy", function () {
    ...
    _createClass(ii, [{
      ...
      key: "_getConfig",
      value: function _getConfig(t) {
        if ("string" != typeof (t = _objectSpread({}, ti, {}, U.getDataAttributes(this._element), {}, "object" == _typeof(t) && t ? t : {})).target && a(t.target)) {
  ...
  function (_R11) {
    ...
    function ri(t, e) {
      ...
      _this45 = _possibleConstructorReturn(this, _getPrototypeOf(ri).call(this, t)), _this45._config = _this45._getConfig(e), _this45._timeout = null, _this45._hasMouseInteraction = !1, _this45._hasKeyboardInteraction = !1, _this45._setListeners();
      return _this45;
    }
    ...
    _createClass(ri, [{
      ...
      key: "_getConfig",
      value: function _getConfig(t) {
        return t = _objectSpread({}, oi, {}, U.getDataAttributes(this._element), {}, "object" == _typeof(t) && t ? t : {}), d("toast", t, this.constructor.DefaultType), t;
      }
    }, {
