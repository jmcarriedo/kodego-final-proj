<?php
    ...
    // $query = "SELECT galleries.gallery_id, galleries.booking_id, galleries.imageName, DISTINCT bookings.booking_id, bookings.customer_id, bookings.eventName, bookings.eventDate
    //     FROM galleries JOIN bookings ON galleries.booking_id = bookings.booking_id WHERE bookings.customer_id = $user_id";
                        ...
                        <tbody>
                            ...
                            <tr>    
                                ...
                                <td>
                                    ...
                                    <button name="view" type="submit" class="item text-secondary">
                                        <i class="fa fa-eye"></i>
                                    </button>
                                    </form>
                                </td>
